            ...
            <div className="max-w-[1400px] mx-auto">
                <div className="flex flex-col lg:flex-row items-center pt-12 lg:pt-20 px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="w-full lg:w-[600px] z-20 mb-12 lg:mb-20">
                        <h1 className="text-[25px] md:text-[38px] font-extrabold text-[#212121] leading-[1.15] mb-6 ">
                            120,000+ study abroad degrees, <br className="hidden md:block" />
                            one perfect for you.
                        </h1>

                        <p className="text-[#424242] text-lg font-normal mb-8">Where will your studies take you?</p>
                        ...
                        <div className="w-full max-w-lg space-y-3 mb-10">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    type="text"
                                    className="block w-full pl-12 pr-4 py-3.5 text-base text-gray-900 bg-white rounded-lg border-0 shadow-[0_2px_8px_rgba(0,0,0,0.08)] focus:ring-2 focus:ring-teal-500 placeholder-gray-500"
                            ...
                            {/* Search Button */}
                            <button className="w-full bg-[#ad1457] hover:bg-[#880e43] text-white font-bold py-3.5 rounded-lg shadow-md transition duration-200 text-lg">
                                Search
                            </button>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                {['Bachelor degrees', 'Masters degrees', 'Preparatory', 'Doctoral Degrees', 'Postgraduate', 'Post-Bachelors'].map((tag) => (
                                    <a key={tag} href="#" className="flex items-center px-2 py-1 rounded-full bg-white border border-gray-200 text-gray-700 text-sm font-medium hover:shadow-md transition shadow-sm whitespace-nowrap shrink-0">
                                        {tag}
                                    </a>
                                ))}
                            </div>
                    ...
                    <div className="hidden lg:block absolute top-0 right-0 h-full w-[60%] overflow-visible pointer-events-none">
                        ...
                        {/* Student Image */}
                        <div className="absolute bottom-0 right-[1%] h-[90%] w-auto z-10 flex items-end">
                            <img
                                src={studentImage}
                    ...
                    <div className="lg:hidden w-full relative h-64 mt-8 overflow-hidden rounded-xl">
