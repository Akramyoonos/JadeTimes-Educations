...
const Footer = () => {
    return (
        <footer className="bg-[#2a2a2a] text-white py-14 font-sans border-t border-gray-800">
            <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-12">
                    ...
                    <div className="flex items-center gap-5 md:mt-10">
                        <ScrollReveal delay="delay-300" animation="fade-in slide-in-from-right-4">
                        ...
                        {/* TikTok Icon (SVG) */}
                        <ScrollReveal delay="delay-400" animation="fade-in slide-in-from-right-4">
                            <a href="#" className="text-white hover:text-gray-300 transition-colors">
                        ...
                        <ScrollReveal delay="delay-500" animation="fade-in slide-in-from-right-4">
                            <a href="#" className="text-white hover:text-gray-300 transition-colors">
                                <Youtube className="w-6 h-6" />
                            </a>
                        </ScrollReveal>

                        <ScrollReveal delay="delay-600" animation="fade-in slide-in-from-right-4">
                            <a href="#" className="text-white hover:text-gray-300 transition-colors">
                        ...
                        {/* Discord Icon (SVG) */}
                        <ScrollReveal delay="delay-700" animation="fade-in slide-in-from-right-4">
                            <a href="#" className="text-white hover:text-gray-300 transition-colors">
                                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <ScrollReveal delay="delay-[800ms]" animation="fade-in slide-in-from-right-4">
                            <a href="#" className="text-white hover:text-gray-300 transition-colors">
                ...
                {/* Bottom Links */}
                <ScrollReveal className="mt-16 md:mt-20 flex flex-wrap gap-x-6 gap-y-2 text-[13px] text-white underline underline-offset-2 font-medium" delay="delay-1000">
