            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                    ...
                    {categories.slice(0, 4).map((cat, index) => (
                        <div key={index} className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow cursor-pointer relative overflow-hidden group border-b-[3px] border-transparent hover:border-[#d81b60]">
                    ...
                    <div className="lg:col-start-5 lg:row-span-2 bg-[#e0f2f1] rounded-lg p-8 flex flex-col justify-center">
                    ...
                    {categories.slice(4).map((cat, index) => (
                        <div key={index + 4} className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow cursor-pointer relative overflow-hidden group border-b-[3px] border-transparent hover:border-[#d81b60]">
                            <div className="absolute bottom-0 left-0 w-full h-[3px] bg-pink-50 group-hover:bg-[#d81b60] transition-colors"></div>
                            <div className="flex flex-col h-full justify-between items-start">
                                <div className="mb-4">
                                    <GraduationCap className="w-8 h-8 text-[#f48fb1]" strokeWidth={1.5} />
